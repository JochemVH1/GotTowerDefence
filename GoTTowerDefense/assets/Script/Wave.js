cc.Class({
	...
	createWave: function (parentNode) {
		...
		{ 		
			...
			enemy.getComponent('Enemy').init(100,this.speedOfWave,i+1,this.path,this.getComponent("Wave"));
	...
	enemyKilled: function(enemy, tower){
		this.enemyPool.put(enemy);
		this.node.parent.getComponent("Level1").increaseMoney(20);
	}
});
